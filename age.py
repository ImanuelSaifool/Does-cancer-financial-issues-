...
df2021p1 = df2021p1.rename(columns={"TOTSLF21": "TOTSLF", "FAMINC21": "FAMINC", "TOTMCD21": "TOTMCD", "TOTMCR21": "TOTMCR", "TOTVA21": "TOTVA", "TOTTRI21": "TOTTRI", "TOTOFD21": "TOTOFD", "TOTSTL21": "TOTSTL", "REGION21": "REGION"})
df2021p2 = df2021p2.rename(columns={"TOTSLF21": "TOTSLF", "FAMINC21": "FAMINC", "TOTMCD21": "TOTMCD", "TOTMCR21": "TOTMCR", "TOTVA21": "TOTVA", "TOTTRI21": "TOTTRI", "TOTOFD21": "TOTOFD", "TOTSTL21": "TOTSTL", "REGION21": "REGION"})
...
main_df = pd.concat([df2014, df2015, df2016, df2017, df2018, df2019, df2020, df2021p1, df2021p2, df2022, df2023], axis=0)
